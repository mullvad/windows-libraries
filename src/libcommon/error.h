...
__declspec(noreturn) void Throw(const char *operation, DWORD errorCode, const char *file, size_t line);
__declspec(noreturn) void Throw(const char *operation, const char *file, size_t line);
