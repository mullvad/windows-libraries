...
const wchar_t *LiteralNamespace(common::wmi::Connection::Namespace ns)
{
	using namespace common::wmi;

	switch (ns)
	{
		case Connection::Namespace::Default: return L"root\\Default";
		case Connection::Namespace::Cimv2: return L"root\\CIMV2";
		case Connection::Namespace::StandardCimv2: return L"root\\StandardCIMV2";
		default:
		{
